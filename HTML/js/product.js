...
function submitProduct() {
  console.log(productPost.name);
  let name = document.getElementById("input__name").value;
  let area = document.getElementById("input__area").value;
  let email = document.getElementById("input__email").value;
  let phone = document.getElementById("input__phone").value;
  let count = document.getElementById("ip__count").value;
  let weight = document.getElementById("input__weight").value;
